create view dbo.vw_londonwest2ctypeantiSO as 
SELECT distinct
...
where [LSOA code (2011)]= 'E01033595' and [Crime type] = 'Anti-social behaviour' 
...
select * from dbo.vw_londonwest2ctypeTheft